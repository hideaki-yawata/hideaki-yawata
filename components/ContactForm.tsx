...
import { pillButtonDisabledClassName } from "@/lib/pillButtonStyles";
    ...
    >
      ...
      <div className="flex w-full flex-col items-end gap-2 xl:items-start">
        <button
          type="submit"
          disabled={isSubmitting}
          className={`group inline-flex cursor-pointer items-center gap-1.5 rounded-[22px] px-3 py-0.5 text-lg font-semibold italic leading-[1.5] disabled:cursor-not-allowed disabled:opacity-50 md:px-4 md:py-1 md:text-2xl ${pillButtonDisabledClassName}`}
        >
